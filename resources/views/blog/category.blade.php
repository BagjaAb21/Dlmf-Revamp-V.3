...
@push('styles')
    <style>
        ...
        /* Sembunyikan versi simple/mobile Laravel yang membuat duplikat */
        .pagination-wrapper nav>div:first-child:not(:last-child) {
            display: none !important;
        }

        /* Memaksa kontainer navigasi menjadi kolom (susun atas-bawah) */
        ...
        /* Rapikan teks informasi di bawah dengan margin tambahan */
        .pagination-wrapper nav p {
            margin: 0 !important;
            margin-top: 5px !important;
            /* Margin tambahan untuk estetika */
        ...
        /* Navigasi PREVIOUS & NEXT (Pill Shape - Desain Bawah) */
        ...
        /* Menambahkan teks PREVIOUS dan NEXT secara eksplisit */
        .page-item:first-child .page-link::before {
            content: '\F12C  PREVIOUS' !important;
            font-family: 'bootstrap-icons', 'Inter', sans-serif !important;
            display: flex !important;
            align-items: center;
            font-weight: 800;
        }
        ...
        .page-item:last-child .page-link::after {
            content: 'NEXT  \F135' !important;
            font-family: 'Inter', 'bootstrap-icons', sans-serif !important;
            display: flex !important;
            align-items: center;
            font-weight: 800;
        }

        /* Sembunyikan teks asli bawaan Laravel agar tidak ganda */
        .page-item:first-child .page-link span,
        .page-item:last-child .page-link span,
        .page-item:first-child .page-link text,
        .page-item:last-child .page-link text {
            display: none !important;
        }

        /* Jika Laravel menggunakan text node langsung, sembunyikan font-size nya */
        .page-item:first-child .page-link,
        .page-item:last-child .page-link {
        ...
        /* Tampilkan kembali font-size untuk pseudo-element */
        .page-item:first-child .page-link::before,
        .page-item:last-child .page-link::after {
            font-size: 0.85rem !important;
        }
        ...
        <div class="search-filter-bar fade-in">
            ...
            <div class="search-box">
                <input type="text" id="search-input" class="search-input"
                    placeholder="Cari artikel dalam kategori {{ $category->name }}..." autocomplete="off"
        ...
        <div id="search-results-info" class="search-results-info {{ request('search') ? 'show' : '' }}">
            <span>
                ...
                <span id="search-results-text">
                    Menampilkan hasil pencarian untuk "<strong>{{ request('search') }}</strong>" dalam
                    {{ $category->name }}
                </span>
            </span>
                    ...
                    @foreach ($posts as $post)
                        <article class="blog-card">
                            <a href="{{ route('blog.show', $post->slug) }}" class="blog-card-image-wrapper">
                                @if ($post->thumbnail)
                                    <img src="{{ Storage::url($post->thumbnail) }}" class="blog-card-image"
                                        alt="{{ $post->title }}" loading="lazy">
                                @else
                                    <img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=800&q=80"
                                        class="blog-card-image" alt="{{ $post->title }}" loading="lazy">
                                @endif
                        ...
                        .then(data => {
                            ...
                            if (data.posts && data.posts.length > 0) {
                                ...
                                blogGridContainer.innerHTML =
                                    `<div class="blog-grid fade-in">${blogCardsHTML}</div>`;
